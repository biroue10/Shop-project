      ...
      <div className="flex-1">
        ...
        <div className="flex mt-8 space-x-4">
          <div className="flex items-center text-center">
            <button
              className="w-12 h-12 rounded-l-md bg-gray-200 hover:bg-gray-300 font-bold text-lg text-orange-500"
              onClick={() => handleQuantityChange(quantity - 1)}
            >
              -
            </button>
            <p className="w-12 h-12 bg-gray-200 flex items-center justify-center">
              {quantity}
            </p>
            <button
              className="w-12 h-12 rounded-r-md bg-gray-200 hover:bg-gray-300 font-bold text-lg text-orange-500"
              onClick={() => handleQuantityChange(quantity + 1)}
            >
              +
            </button>
          ...
          <button
            ...
            className="flex items-center justify-center space-x-4 w-full max-w-xs bg-orange-500 hover:bg-orange-600 rounded-md shadow-md shadow-orange-300 text-white"
          >
